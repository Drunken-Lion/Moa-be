...
class PlaceControllerTest {
    ...
    void t1() throws Exception {
        ...
        actions
                ...
                .andExpect(jsonPath("$.[0].open").value(LocalDate.of(2024, 10, 15).toString()))
                .andExpect(jsonPath("$.[0].close").value(LocalDate.of(2025, 3, 12).toString()))
                .andExpect(jsonPath("$.[0].recLevel").value(PlaceLevel.LEVEL_1.toString()))
                .andExpect(jsonPath("$.[0].createdAt", matchesPattern(TestUtil.DATETIME_PATTERN)))

                .andExpect(jsonPath("$.[0].images", notNullValue()))

                .andExpect(jsonPath("$.[0].address.id", instanceOf(Number.class)))
                .andExpect(jsonPath("$.[0].address.address").value("강원도 홍천군 서면 한치골길 262"))
                .andExpect(jsonPath("$.[0].address.addressDetail", nullValue()))
                .andExpect(jsonPath("$.[0].address.locationX").value(127.687106349987))
                ...
                .andExpect(jsonPath("$.[0].specificDays[0].date").value(LocalDate.of(2025, 1, 28).format(TestUtil.DATE_FORMATTER)))
